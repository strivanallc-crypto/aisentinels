        ...
        {loading ? (
          ...
          <div className="divide-y" style={{ borderColor: 'rgba(255,255,255,0.08)' }}>
            {filtered.map((r, i) => {
              ...
              return (
                <div key={r.id} className="flex items-center gap-4 px-4 py-4 transition-colors hover:bg-white/5">
                  ...
                  <div className="flex items-center gap-6 flex-shrink-0">
                    <div className="text-center"><p className="text-[10px] uppercase" style={{ color: '#4b5563' }}>L</p><p className="text-[13px] font-semibold">{r.likelihood}</p></div>
                    <div className="text-center"><p className="text-[10px] uppercase" style={{ color: '#4b5563' }}>I</p><p className="text-[13px] font-semibold">{r.impact}</p></div>
                    <div className="text-center"><p className="text-[10px] uppercase" style={{ color: '#4b5563' }}>Score</p><p className="text-[13px] font-bold" style={{ color: level.color }}>{r.riskScore}</p></div>
                  </div>
